...
class HybridAStar {
 public:
    ...
    bool Plan(
        ...
        double ey,  // 起点终点状态
        double ephi,
        const std::vector<double> &XYbounds,  // 地图范围
 ...
 private:
    ...
    bool GenerateSpeedAcceleration(
        HybridAStartResult *result);  // 获得速度加速度
    bool GenerateSCurveSpeedAcceleration(
        HybridAStartResult *result);  // 生产s曲线
