...
bool DistanceApproachIPOPTRelaxEndInterface::eval_jac_g(int n,
                                                        const double *x,
                                                        bool new_x,
                                                        int m,
                                                        int nele_jac,
...
bool DistanceApproachIPOPTRelaxEndInterface::eval_jac_g_ser(int n,
                                                            const double *x,
                                                            bool new_x,
                                                            int m,
                                                            int nele_jac,
...
//***************    start ADOL-C part ***********************************
template <class T>
void DistanceApproachIPOPTRelaxEndInterface::eval_obj(int n,
                                                      const T *x,
                                                      T *obj_value) {
    // Objective is :
    // min control inputs
...
template <class T>
void DistanceApproachIPOPTRelaxEndInterface::eval_constraints(int n,
                                                              const T *x,
                                                              int m,
                                                              T *g) {
    // state start index
...
bool DistanceApproachIPOPTRelaxEndInterface::check_g(int n,
    ...
    for (int idx = 0; idx < m; ++idx) {
        if (g[idx] > g_u_tmp[idx] + delta_v ||
            ...
            std::cout << "constratins idx unfeasible: " << idx
