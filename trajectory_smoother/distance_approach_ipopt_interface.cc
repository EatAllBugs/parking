...
bool DistanceApproachIPOPTInterface::get_nlp_info(int &n,
                                                  int &m,
                                                  int &nnz_jac_g,
                                                  int &nnz_h_lag,
...
bool DistanceApproachIPOPTInterface::eval_f(int n,
                                            const double *x,
                                            bool new_x,
                                            double &obj_value) {
...
bool DistanceApproachIPOPTInterface::eval_g(
...
bool DistanceApproachIPOPTInterface::eval_jac_g(int n,
                                                const double *x,
                                                bool new_x,
                                                int m,
                                                int nele_jac,
...
bool DistanceApproachIPOPTInterface::eval_jac_g_ser(int n,
                                                    const double *x,
                                                    bool new_x,
                                                    int m,
                                                    int nele_jac,
...
void DistanceApproachIPOPTInterface::get_optimization_results(
    ...
    *dual_n_result = dual_n_result_;
    ...
    for (int i = 0; i < horizon_ + 1; ++i) {
        for (int j = 0; j < obstacles_edges_sum_; ++j) {
            l_diff_max = std::max(
                std::abs(l_warm_up_(j, i) - dual_l_result_(j, i)), l_diff_max);
        }
    }
    ...
    for (int i = 0; i < horizon_ + 1; ++i) {
        for (int j = 0; j < 4 * obstacles_num_; ++j) {
            n_diff_max = std::max(
                std::abs(n_warm_up_(j, i) - dual_n_result_(j, i)), n_diff_max);
        }
    }
...
template <class T>
void DistanceApproachIPOPTInterface::eval_constraints(int n,
                                                      const T *x,
                                                      int m,
                                                      T *g) {
    // state start index
...
bool DistanceApproachIPOPTInterface::check_g(int n,
                                             const double *x,
                                             int m,
                                             const double *g) {
    int kN = n;
...
void DistanceApproachIPOPTInterface::generate_tapes(int n,
                                                    int m,
                                                    int *nnz_jac_g,
                                                    int *nnz_h_lag) {
